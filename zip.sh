...
echo "Zipping..."
zip -r $OUTFILE . -x zip.sh report/\* \*.git\* img/\* data/\* .venv/\* .vscode/\* README.md LICENSE requirements.txt results/\* *__MACOSX/\* *__pycache__/\* src/baseline_results/\* src/no_regression/\* src/myVOC4/\*
