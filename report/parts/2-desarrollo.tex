...
\subsection{\textit{Anchors}}
    ...
    \pngfigure[0.9]{ratio_v_box}{Relación entre la relación de aspecto y las bounding boxes}
    ...
    \pngfigure[0.9]{ratio_v_anchors}{Relación entre la relación de aspecto y los anchors}
...
\subsection {\textit{RoI pooling} y clasificación}
    ...
    \pngfigure{dconf}{Matriz de confusión}
...
\subsection{Análisis de las funciones de pérdida}
Para analizar las funciones de pérdida, 
